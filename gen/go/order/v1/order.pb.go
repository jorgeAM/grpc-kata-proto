...
func (x *CreateOrderRequest) GetItems() []*Items {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *Items) GetProductCode() string {
	if x != nil {
...
func (x *Items) GetQuantity() uint32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *Items) GetUnitPrice() float32 {
	if x != nil {
		return x.UnitPrice
	}
	return 0
...
const file_order_v1_order_proto_rawDesc = "" +
	"\n" +
	"\x14order/v1/order.proto\"l\n" +
	"\x12CreateOrderRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1c\n" +
	"\x05items\x18\x02 \x03(\v2\x06.ItemsR\x05items\x12\x1f\n" +
